    ...
    render() {
        return (
            <>
                ...
                <p>
                    В университете изучал <b>SQL</b> и <b>Oracle</b>. На втором курсе самостоятелно изучал
                ...
                <p>
                    Сейчас делаю проект используя <span>SQL SERVER</span>. Архитекткру данной БД можно увидеть <a
                ...
                <p>
                    Бек для данного проекта пишу используя ASP.NET и немного Linq2db. Зарпосы для ASP.NET можно просмотреть <a
