...
function ProgrammingLanguages() {
    return (
        <>
            ...
            <p>
                Fullstack-разработчик. Тимлид разработки с июня 2025 года.
                В последнее время активно работаю Java + PostgreSQL на беке и React TS|TSX + Redux на фронте.
                Получил красный аттестат по бакалавариату, сейчас заканчиваю второй курс магистратуры. Трудолюбивый и амбициозный. 
                Хочу узнавать новые технологии и применять их в работе. Люблю ходить на meetup (правда в Самаре они проводят не так часто). 
